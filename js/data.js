let data = [
  ...
  **************/
  {
    ...
    icon: "img/c.png",
    desc: `
      C was originally developed by Dennis Ritchie between 1972 and 1973 at Bell
      Labs. It was created to make utilities running on Unix.
    `
  },
  {
  ...
  },
  {
    ...
    desc: `
      ...
      behaviors of web page content by implementing a markup based pattern
      to it. Cascading Style Sheets (CSS) is a style sheet language used for
  ...
  },
  {
    ...
    desc: `
      ...
      programming language that conforms to the ECMAScript specification. It is
      a language that is also characterized as dynamic, weakly typed,
  ...
  },
  {
    ...
    desc: `
      ...
      into Cascading Style Sheets (CSS). SassScript is the scripting language
      itself.
    `
  },
  {
    ...
    desc: `
      ...
      Project. First released in 1989, it has been distributed widely as the
      default login shell for most Linux distributions and Apple"s macOS.
    `
  },
  /*************
  *
  ...
  **************/
  ...
  },
  {
    ...
    desc: `
      ...
      visualizations in web browsers. It makes use of the widely implemented
      SVG, HTML5, and CSS standards.
    `
  },
  {
  ...
  **************/
  ...
  },
  {
    ...
    desc: `
      ...
      become one of the most popular front-end frameworks and open source
  ...
  **************/
  {
    ...
    desc: `
      Jenkins is an open source automation server written in Java. Jenkins helps
      to automate the non-human part of the software development process, with
  ...
  },
  {
    ...
    desc: `
      ...
      may be tested at no charge via travis-ci.org.
    `
  },
  {
    ...
    icon: "img/gulp.png",
    desc: `
      Gulp is an open-source JavaScript toolkit by Fractal Innovations and the
      open source community at GitHub, used as a streaming build system in
  ...
  **************/
  ...
  },
  {
    ...
    desc: `
      Jasmine is a behavior-driven development framework for Code Analysis
      JavaScript code. It does not depend on any other JavaScript frameworks. It
      does not require a DOM. And it has a clean, obvious syntax so that you can
      easily write tests.
    `
  },
  /*************
  ...
  **************/
  {
    ...
    desc: `
      ...
      browsers. The main purpose of Karma is to make your test-driven
  ...
  },
  {
    ...
    desc: `
      ...
      of the xUnit architecture for unit Code Analysis frameworks.
    `
  },
  {
    ...
    icon: "img/tox.png",
    desc: `
      Tox aims to automate and standardize Code Analysis in Python. It is part
      of a larger vision of easing the packaging, Code Analysis and release
  ...
  },
  {
    ...
    desc: `
      Micro Focus Fortify Static Code Analyzer reduces software risk by
      identifying security vulnerabilities that pose the biggest threats to your
      organization. It pinpoints the root cause of the vulnerability, correlates
      and prioritizes results, and provides best practices so developers can
      develop code more securely.
    `
  },
  {
  ...
  },
  {
    ...
    desc: `
      ...
      linting. It uses a command-line interface to run custom tasks defined
      in a file.
    `
  },
  {
  ...
  **************/
  ...
  },
  {
    ...
    desc: `
      ...
      was announced as a result of a merger of the OpenECOMP and
      Open-Orchestrator projects. ONAP provides a platform for real-time,
  ...
  **************/
  {
    ...
    desc: `
      ...
      mostly deployed as infrastructure-as-a-service, whereby virtual servers
      and other resources are made available to customers.
    `
  },
  {
    ...
    desc: `
      ...
      Microsoft Office. Launched in 2001, SharePoint is primarily sold as a
  ...
  },
  {
    ...
    icon: "img/aws.png",
    desc: `
      Amazon Web Services is a subsidiary of Amazon that provides on-demand
      cloud computing platforms to individuals, companies and governments, on a
      paid subscription basis. The technology allows subscribers to have at
      their disposal a virtual cluster of computers, available all the time,
  ...
  },
  {
    ...
    desc: `
      ...
      open-source cross-platform web server software, released under the terms
      of Apache License 2.0. Apache is developed and maintained by an open
  ...
  },
  {
    ...
    desc: `
      ...
      balancer, mail proxy and HTTP cache. The software was created by Igor
      Sysoev and first publicly released in 2004.
    `
  },
  /*************
  *
  ...
  **************/
  {
    ...
    icon: "img/atom.png",
    desc: `
      Atom is a free and open-source text and source code editor for macOS,
      Linux, and Microsoft Windows with support for plug-ins written in Node.js,
  ...
  },
  {
    ...
    desc: `
      ...
      Google Chrome browser. DevTools can help you edit pages on-the-fly and
      diagnose problems quickly, which ultimately helps you build better
      websites, faster.
    `
  },
  {
  ...
  },
  {
    ...
    desc: `
      ...
      programming, and is the most widely used Java IDE.[6] It contains a base
  ...
  **************/
  ...
  },
  {
    ...
    desc: `
      ...
      of web services in computer networks. Its purpose is to induce
  ...
  },
  {
    ...
    icon: "img/safe.png",
    desc: `
      The Scaled Agile Framework (abbreviated as SAFe), is a set of organization
      and workflow patterns intended to guide enterprises in scaling lean and
      agile practices.
    `
  },
  {
    ...
    icon: "img/agile.png",
    desc: `
      Scrum is an agile framework for managing knowledge work, with an emphasis
      on software development. It is designed for teams of three to nine
      members, who break their work into actions that can be completed within
  ...
  },
  {
    ...
    desc: `
      ...
      manufacturing. Taiichi Ohno, an industrial engineer at Toyota, developed
      kanban to improve manufacturing efficiency. Kanban is one method to
      achieve JIT.
    `
  }
];
